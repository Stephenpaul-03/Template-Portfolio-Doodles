...
export function HeroSection() {
  ...
  return <section className="scrap-hero scrap-container" aria-labelledby="hero-title">
    <div className="scrap-hero-copy">
      ...
      <h1 id="hero-title">Hello, I’m Steve.<br/>I make things<br/><span className="scrap-underlined">make sense.</span></h1>
      ...
      <div className="scrap-hero-foot"><span className="scrap-hand">Glad you found your way here.</span><span className="scrap-label">Based in India · Open to the world</span></div>
    </div>
    <div className="scrap-hero-collage">
      ...
      <button onClick={() => setNote((note + 1) % notes.length)} className="scrap-hero-note" aria-label="Read another studio thought">
        <span className="scrap-label">A thought I keep coming back to</span><span className="scrap-hand" aria-live="polite">{notes[note]}</span><span className="scrap-note-index">0{note + 1} / 03 <ArrowUpRight size={15}/></span>
      </button>
