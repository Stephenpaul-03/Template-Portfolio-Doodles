...
export function AboutSection() {
  ...
  return <section id="about" className="scrap-section scrap-container">
    ...
    <div className="scrap-about-layout">
      <aside className="scrap-id-card"><span className="scrap-tape" aria-hidden="true"/><div className="scrap-avatar" aria-hidden="true">s<span>.</span></div><p className="scrap-hand">Stephen Paul</p><span className="scrap-label">Designer + builder</span><div className="scrap-id-lines"><span>HOME BASE <b>India</b></span><span>DEFAULT SETTING <b>Curious</b></span><span>FAVOURITE QUESTION <b>What if?</b></span></div></aside>
